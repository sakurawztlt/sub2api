...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	engine := server.ProvideRouter(configConfig, handlers, jwtAuthMiddleware, adminAuthMiddleware, apiKeyAuthMiddleware, apiKeyService, subscriptionService, opsService, settingService, trafficCaptureService, compositeRouteResolver, redisClient)
