...
func init() {
	...
	groupDescSearchPricePer1k := groupFields[28].Descriptor()
	...
	groupDescAudioRealtimePricePerMin := groupFields[29].Descriptor()
	...
	groupDescAudioTtsPricePerMillionChars := groupFields[30].Descriptor()
	...
	groupDescAudioSttPricePerHour := groupFields[31].Descriptor()
	...
	userDescRestrictPublicGroups := userFields[14].Descriptor()
