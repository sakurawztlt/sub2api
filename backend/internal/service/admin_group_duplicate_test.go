...
func TestDuplicateGroupCopiesConfigurationDeeplyAndResetsRuntimeState(t *testing.T) {
	...
	source := &Group{
		...
		AudioRealtimePricePerMin:     groupDuplicateTestPointer(0.2),
		AudioTTSPricePerMillionChars: groupDuplicateTestPointer(12.0),
		AudioSTTPricePerHour:         groupDuplicateTestPointer(0.8),
		LongContextPricingEnabled:    true,
		ModelPricing: []ChannelModelPricing{{
			Models:      []string{"gpt-5.4"},
			InputPrice:  groupDuplicateTestPointer(0.000001),
			OutputPrice: groupDuplicateTestPointer(0.000002),
		}},
		ClaudeCodeOnly:                  true,
	...
	require.Equal(t, source.ProfitControlEnabled, duplicate.ProfitControlEnabled)
