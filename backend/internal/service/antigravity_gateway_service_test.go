...
func TestAntigravityGatewayService_ForwardGemini_ImageUsesDefaultMappingAndOAuth(t *testing.T) {
	...
	account := &Account{
		ID: 104, Name: "antigravity-image", Platform: PlatformAntigravity, Type: AccountTypeOAuth, Status: StatusActive, Concurrency: 1,
		Credentials: map[string]any{"access_token": "test-access-token", "project_id": "test-project"},
	}
