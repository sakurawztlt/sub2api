...
var (
	...
	// would be encrypted with an auto-generated (ephemeral) key. That key changes
	// on every process start, making the persisted ciphertext undecryptable after
	// a restart or upgrade (#4524).
...
type BackupService struct {
	...
	// means the encryption key is ephemeral and cannot safely protect durable
...
// EncryptionKeyConfigured reports whether a fixed secret encryption key is in
// use. Durable secret writers must refuse an auto-generated key because it does
