...
func openAIFastPassAllSettingService() *SettingService {
	return NewSettingService(&openAIFastPolicyRepoStub{values: map[string]string{
...
func TestForwardAsChatCompletions_ServiceTierFastNormalizedToPriorityUpstream(t *testing.T) {
	...
	svc := &OpenAIGatewayService{
		...
		settingService: openAIFastPassAllSettingService(),
	}
	account := &Account{
		ID:          21,
