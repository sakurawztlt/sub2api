...
func TestForwardAsChatCompletions_BufferedResponseFailedTriggersFailover(t *testing.T) {
	...
	require.Contains(t, string(failoverErr.ResponseBody), "Network error. Please retry.")
	require.NotContains(t, string(failoverErr.ResponseBody), "input exceeds the context window")
