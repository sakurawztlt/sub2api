...
func (s *BillingService) computeCacheCreationCost(pricing *ModelPricing, tokens UsageTokens, effectivePrice float64) float64 {
	...
	return float64(tokens.CacheCreationTokens) * effectivePrice
}
