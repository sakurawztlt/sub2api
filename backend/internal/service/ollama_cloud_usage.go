...
var ollamaCloudUsageManagedExtraKeys = []string{
	OllamaCloudUsageSessionExtraKey,
	OllamaCloudUsageAutoRefreshExtraKey,
	OllamaCloudUsageSnapshotExtraKey,
}

func cloneWithoutOllamaCloudUsageManagedExtra(extra map[string]any) map[string]any {
...
func preserveOllamaCloudUsageManagedExtra(source, target map[string]any) {
	for _, key := range ollamaCloudUsageManagedExtraKeys {
		delete(target, key)
