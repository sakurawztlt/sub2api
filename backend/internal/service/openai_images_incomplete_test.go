...
func TestImagesOAuthNonStreaming_TextFallbackReturnsCapabilityError_D451Contract(t *testing.T) {
	upstreamSSE := "event: response.created\n" +
		"data: {\"type\":\"response.created\",\"response\":{\"id\":\"r\",\"status\":\"in_progress\",\"model\":\"gpt-5.4-mini\",\"output\":[]}}\n\n" +
		"event: response.output_text.delta\n" +
...
func TestImagesOAuthStreaming_SplitSafetyRefusalReturns400_D451Contract(t *testing.T) {
	upstreamSSE := "event: response.output_text.delta\n" +
