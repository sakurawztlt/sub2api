<template>
  <div v-if="visible" class="space-y-1">
    ...
    <div class="flex flex-wrap items-center gap-1.5">
      ...
      >
        <svg
          class="h-2.5 w-2.5 motion-reduce:animate-none"
      ...
      <button
        type="button"
        class="inline-flex items-center gap-0.5 rounded px-1.5 py-0.5 text-[10px] font-medium text-orange-600 transition-colors hover:bg-orange-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-500/50 disabled:cursor-not-allowed disabled:opacity-50 dark:text-orange-400 dark:hover:bg-orange-900/30"
    ...
    <div v-if="primaryResetCreditExpiry" class="space-y-1">
      <div class="flex flex-wrap items-center gap-1">
        ...
        <button
          ...
          class="inline-flex items-center rounded-full bg-gray-100 px-1.5 py-0.5 text-[10px] font-medium leading-4 text-gray-600 transition-colors hover:bg-gray-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-500/50 dark:bg-dark-800 dark:text-gray-300 dark:hover:bg-dark-700"
      ...
      >
        ...
        >
          <span class="h-1 w-1 shrink-0 rounded-full bg-gray-400 dark:bg-dark-500" aria-hidden="true" />
...
const countButtonAriaLabel = computed(() => {
  if (!data.value) return countButtonTitle.value
  return `${countButtonTitle.value}: ${availableResetCount.value}`
})
