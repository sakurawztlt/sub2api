<template>
  ...
  >
    <form id="bulk-edit-account-form" class="space-y-5" @submit.prevent="() => handleSubmit()">
      ...
      <div
        v-if="allOpenAILongContextCapable"
        class="border-t border-gray-200 pt-4 dark:border-dark-600"
      >
...
// Long-context billing is supported by all OpenAI credential types. Keep this
// separate from passthrough capability so setup-token accounts do not regain
// the locally disabled passthrough controls.
...
const buildUpdatePayload = (): Record<string, unknown> | null => {
  ...
  const applyOpenAILongContextBilling =
    enableOpenAILongContextBilling.value && allOpenAILongContextCapable.value
