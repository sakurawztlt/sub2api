...
describe('EditAccountModal', () => {
  ...
  // codex upstream PR#2450 cherry-pick — Responses mode override tests only.
  // Codex image generation bridge test from same PR dropped (separate feature
  // not wired in local fork).
