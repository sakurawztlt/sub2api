export default {
  ...
  admin: {
    ...
    groups: {
      ...
      modelPricing: {
        ...
        description:
          'Overrides channel and built-in prices for matching models. Long-context tiers come from official presets — do not enter custom intervals. Use per-request tiers such as realtime, tts, and stt for audio.',
        longContext: 'Enable long-context tier pricing',
        longContextHint:
          'When checked, channel intervals or official preset tiers apply. Otherwise the first tier is used unless the account explicitly enables long-context billing.',
        add: 'Add model price'
      },
    ...
    riskControl: {
      ...
      preBlockKeyIdleShort: 'Idle',
      preBlockKeyFrozenShort: 'Frozen',
      allGroups: 'All Groups',
    ...
    accounts: {
      ...
      bulkEdit: {
        ...
        successWithInherited:
          'Updated {count} account(s). {inherited} selected shadow account(s) still follow their parent account.',
        partialSuccess: 'Partially updated: {success} succeeded, {failed} failed',
        partialSuccessWithInherited:
          'Partially updated: {success} succeeded, {failed} failed. {inherited} selected shadow account(s) still follow their parent account.',
        ...
        longContextShadowHint:
          'Long-context billing belongs to the parent account. Selected shadow accounts keep following their parent, including when targets come from a filter.',
        longContextParentRequired:
          'All selected accounts are shadows. Select the parent account to change long-context billing.',
      ...
      headerOverride: {
        ...
        importJsonPlaceholder: '{"accept-language": "en-US", "x-relay-token": "..."}',
        importJsonApply: 'Parse & Fill',
        importJsonCancel: 'Cancel',
        importJsonHint:
          'Paste a flat JSON object (header name to value). Parsing replaces the current rows.',
        importJsonInvalid:
          'Invalid JSON: expected a flat object of header name to string value',
      ...
      grokCustomBaseUrl: {
        ...
        hint:
          'When enabled, account traffic is forwarded to this address. OAuth authorization and token refresh remain on official endpoints.',
      ...
      oauth: {
        ...
        grok: {
          ...
          errors: {
            GROK_OAUTH_SESSION_NOT_FOUND: 'The OAuth session has expired. Generate a new authorization URL.',
            GROK_OAUTH_INVALID_STATE: 'The OAuth state is invalid. Generate a new authorization URL and try again.',
            GROK_OAUTH_STATE_REQUIRED: 'The OAuth state is required. Paste the complete callback URL or query string.',
            GROK_OAUTH_CODE_REQUIRED: 'The authorization code is required.',
            GROK_OAUTH_NO_REFRESH_TOKEN: 'xAI did not return a refresh token. Re-authorize the account and try again.',
            GROK_OAUTH_PROXY_NOT_AVAILABLE: 'The selected proxy is unavailable. Choose another proxy and try again.',
            GROK_OAUTH_PROXY_NOT_FOUND: 'The selected proxy no longer exists. Choose another proxy and try again.'
          }
        },
        // Gemini specific
	        gemini: {
    ...
    settings: {
      ...
      gatewayForwarding: {
        ...
        openaiCodexUserAgentHint: 'The full Codex User-Agent fingerprint used for OAuth outbound requests. Leave empty to build the standard codex_cli_rs identity from the version below. If set, its version segment is still rebuilt from the effective version so UA, originator, and version never drift apart.',
        openaiCodexClientVersion: 'Codex client version',
        openaiCodexClientVersionPlaceholder: 'Leave empty to follow auto-sync',
        openaiCodexClientVersionHint: 'The version declared to the upstream by both User-Agent and the version header. Leave empty to use the auto-synced latest stable release; setting a value pins it.',
        openaiCodexVersionAutoSync: 'Auto-sync Codex version',
        openaiCodexVersionAutoSyncHint: 'Fetches the latest stable client version from the official repository every 6 hours. When disabled, only the pinned version above or the built-in version is used.',
      ...
      payment: {
        ...
        quickAmountsHint: 'Comma-separated positive amounts shown as quick recharge buttons.',
        quickAmountsFormatError: 'Quick amounts must contain at least one positive number.',
        ...
        alipayMobilePrecreateDeepLinkHint: 'Use official Alipay precreate on mobile, open the Alipay app, and show the dynamic QR only if handoff fails',
        helpText: 'Help Text',
      ...
      openaiFastPolicy: {
        ...
        modelWhitelistHint:
          'Models in this list use Action; models outside it use Other models action. Leave empty to apply Action to all models. Supports exact matches and wildcard prefixes (e.g., gpt-5.6*).',
  ...
  payment: {
    ...
    qr: {
      ...
      exactAmountWarning: 'Please pay the exact amount shown',
