...
const openaiPresetMappings = [
  ...
  { label: 'Sonnet5→5.5', from: 'claude-sonnet-5', to: 'gpt-5.5', color: 'bg-amber-100 text-amber-700 hover:bg-amber-200 dark:bg-amber-900/30 dark:text-amber-400' },
...
const bedrockPresetMappings = [
  ...
  { label: 'Sonnet 5', from: 'claude-sonnet-5', to: 'anthropic.claude-sonnet-5', color: 'bg-cyan-100 text-cyan-700 hover:bg-cyan-200 dark:bg-cyan-900/30 dark:text-cyan-400' },
