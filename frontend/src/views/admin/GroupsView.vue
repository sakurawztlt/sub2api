        ...
        >
          ...
          <div class="mt-4 border-t border-dashed border-gray-200 pt-4 dark:border-dark-700">
            ...
            <div class="mt-3 grid grid-cols-1 gap-3 md:grid-cols-2">
              <label class="block">
                <span class="input-label">{{ t("admin.groups.explicitPricing.searchPricePer1k") }}</span>
                <input v-model.number="createForm.search_price_per_1k" type="number" step="0.000001" min="0" class="input" />
              </label>
              <label class="block">
                <span class="input-label">{{ t("admin.groups.voicePricing.audioRealtimePerMin") }}</span>
                <input v-model.number="createForm.audio_realtime_price_per_min" type="number" step="0.000001" min="0" class="input" />
              </label>
              <label class="block">
                <span class="input-label">{{ t("admin.groups.voicePricing.audioTtsPerMillionChars") }}</span>
                <input v-model.number="createForm.audio_tts_price_per_million_chars" type="number" step="0.000001" min="0" class="input" />
              </label>
              <label class="block">
                <span class="input-label">{{ t("admin.groups.voicePricing.audioSttPerHour") }}</span>
                <input v-model.number="createForm.audio_stt_price_per_hour" type="number" step="0.000001" min="0" class="input" />
              </label>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div class="mt-4 border-t border-dashed border-gray-200 pt-4 dark:border-dark-700">
            ...
            <div class="mt-3 grid grid-cols-1 gap-3 md:grid-cols-2">
              <label class="block">
                <span class="input-label">{{ t("admin.groups.explicitPricing.searchPricePer1k") }}</span>
                <input v-model.number="editForm.search_price_per_1k" type="number" step="0.000001" min="0" class="input" />
              </label>
              <label class="block">
                <span class="input-label">{{ t("admin.groups.voicePricing.audioRealtimePerMin") }}</span>
                <input v-model.number="editForm.audio_realtime_price_per_min" type="number" step="0.000001" min="0" class="input" />
              </label>
              <label class="block">
                <span class="input-label">{{ t("admin.groups.voicePricing.audioTtsPerMillionChars") }}</span>
                <input v-model.number="editForm.audio_tts_price_per_million_chars" type="number" step="0.000001" min="0" class="input" />
              </label>
              <label class="block">
                <span class="input-label">{{ t("admin.groups.voicePricing.audioSttPerHour") }}</span>
                <input v-model.number="editForm.audio_stt_price_per_hour" type="number" step="0.000001" min="0" class="input" />
              </label>
            </div>
          </div>
        </div>
...
const usageMap = ref<Map<number, GroupUsageSummary>>(
  new Map(),
);
...
const handleCreateGroup = async () => {
  ...
  try {
    ...
    const requestData = {
      ...
      image_rate_multiplier: normalizeRateMultiplier(
...
const handleUpdateGroup = async () => {
  ...
  try {
    ...
    const payload = {
      ...
      video_model_prices: serializeVideoModelPrices(editForm.video_model_prices),
      image_rate_multiplier: normalizeRateMultiplier(
